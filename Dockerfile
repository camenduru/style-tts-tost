...
RUN pip install -q opencv-python imageio imageio-ffmpeg ffmpeg-python av runpod \
	...
	aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/TostAI/tost-tts/resolve/main/tost-tts-base-v1.2.pth -d /content/tost-tts/Models/LJSpeech -o epoch_2nd_00030.pth && \
